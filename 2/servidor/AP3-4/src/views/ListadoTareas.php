...
class ListadoTareas
{
    ...
    public function __construct(array $rows = null)
    {
        if(is_null($rows)){
            ...
            echo "<p><a href='/AP3-4/public/addTask'>Añadir tarea nueva</p>";
            ...
            if (count($rows) > 0) {
                echo "<table border='1'>";
                echo "<p><a href='/AP3-4/public/addTask'>Añadir tarea nueva</p>";
                echo "<tr><td>actions</td><td>Título</td><td>Descripción</td><td>Fecha de Creación</td><td>Fecha de Vencimiento</td></tr>";
                foreach ($rows as $row){
                    echo "<tr><td><a href='/AP3-4/public/deleteTask/".$row["id"]."'>" . "delete" . "</a></td>
                        <td><a href='/AP3-4/public/detalle/".$row["id"]."'>" . $row["titulo"] .
